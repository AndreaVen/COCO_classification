# -*- coding: utf-8 -*-
"""
Created on Mon Jan 27 16:28:12 2020

@author: Andrea Venditti
This version removes 7 of the 10 classes to simplify the problem, the last 2 pretrained dense layers are used alongside the rest
of the network
"""
...
import time
from dict_generator_reduced import generate_dict
...
if __name__ == '__main__':
    ...
    predictions = Dense(3, activation="softmax",name='softmax_layer')(x)
    ...
    NAME='Reduced_2_{}'.format(int(time.time()))
    tensorboard=TensorBoard(log_dir='./logs/{}'.format(NAME))
    # Save the model according to the conditions  
    check_name=path_to_save+'coco_vgg16_reduced_2_{}'.format(int(time.time()))
