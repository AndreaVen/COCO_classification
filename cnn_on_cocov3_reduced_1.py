...
This version removes 7 of the 10 classes to simplify the problem, the last 2 dense layers from the pretrained network 
are re-initialized as random
"""
...
if __name__ == '__main__':
    ...
    NAME='Reduced_1-{}'.format(int(time.time()))
    tensorboard=TensorBoard(log_dir='./logs/{}'.format(NAME))
    # Save the model according to the conditions  
    check_name=path_to_save+'\\coco_vgg16_reduced_1_{}'.format(int(time.time()))
